...
const popupForCardImage = new PopupWithImage(popupBrowseImg)
      ...
      const card = new Card(
        {
          data: item,
          handleCardClick: () => {
            popupForCardImage.setEventListeners()
            popupForCardImage.openPopUp(item.name, item.link)
          },
        },
        '#element-template'
      )
          ...
          const newCard = new Card(
            {
              ...
              handleCardClick: () => {
                popupForCardImage.setEventListeners()
                popupForCardImage.openPopUp(data.name, data.link)
              },
            },
            '#element-template'
          )
