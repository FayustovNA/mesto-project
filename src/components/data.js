...
export const popUpEl = document.querySelector('#element');
export const popupBrowse = document.querySelector('#browse');
export const buttonSaveElement = popUpEl.querySelector('.popup__button-save');
export const buttonLike = document.querySelectorAll('.element__like');
export const formElements = popUp.querySelector('.form');
export const formCard = popUpEl.querySelector('.form');
...
export const mask = popUpEl.querySelector('#url-input');
export const title = popUpEl.querySelector('#name-input');
